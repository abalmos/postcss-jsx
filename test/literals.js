...
describe("template literals", () => {
	...
	it("interpolation as the only content of a component", () => {
		const file = require.resolve("./fixtures/interpolation-content");
		let code = fs.readFileSync(file);
	...
	it("selector", () => {
		const file = require.resolve("./fixtures/tpl-selector");
		let code = fs.readFileSync(file);
	...
	describe("decl", () => {
		const file = require.resolve("./fixtures/tpl-decl");
	...
	it("non-literals", () => {
		const file = require.resolve("./fixtures/tpl-special");
		let code = fs.readFileSync(file);
	...
	describe("template-safe-parse", () => {
		[
			"./fixtures/tpl-in-tpl",
			"./fixtures/multiline-arrow-function",
			"./fixtures/interpolation-content",
			"./fixtures/tpl-selector",
			"./fixtures/tpl-decl",
			"./fixtures/tpl-special",
		].map(file => {
			it(file, () => {
